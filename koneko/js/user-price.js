        ...
        (result) => {
            if(result.isConfirmed){
                ...
                swal.fire('Los cambios han sido guardados','','success').then(
                    (result)=>{
                        window.location.replace("cotizaciones.html");
                    }
                );
            }else{
    ...
    if(employees > 0){
        ...
        for(const i in tableUser){
            ...
            if(varUser.idUser == employees){
                ...
                document.getElementById("price").value = varUser.price;
                ...
                document.getElementById("product").value = varUser.product;
                document.getElementById("value").value = varUser.value;
            }
        }
    }
}