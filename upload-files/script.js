...
function uploadFile(file){
    ...
    li.innerHTML = `
        <div class="col">
            <i class="fa-solid ${iconSelector(file.type)} file-img"></i>
        </div>
        <div class="col">
            <div class="file name">
...
//    if (splitType === "pdf") {
//        return 'pdf-icon.png';  // Usa un icono para PDF
//    }
...
function iconSelector(type){
    ...
    if (type === "application/pdf") {
        return 'fa-file-pdf';  // Ícono para PDF
...
//        return 'fa-file-image';  // Ícono para imágenes
//    }
//    return 'fa-file';  // Ícono genérico si no es PDF ni imagen
//}